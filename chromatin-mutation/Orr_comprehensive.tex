...
By Lehr's equation, to distinguish between two rates that differ by R with power $\beta$ and significance $\alpha$, the equation $\frac{2 * (Z_{1 - \frac{\alpha}{2}} + Z_{1 - \beta})^2}{{\sqrt{\lambda_1} - \sqrt{\lambda_2}}^2}$. With $\alpha$ = 0.05 and $\beta$ = 0.2, a 5\% increase in the rate parameter can be detected using more than 1312 mutations.
